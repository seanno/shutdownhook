...
<xsl:stylesheet version="1.0"
    ...
    <xsl:param name="useJavascript" select="'false'"/>
    ...
    <xsl:param name="dohtmlfooter">false</xsl:param>
            ...
            <head>
                ...
                <style type="text/css" media="all">
				  .ccda *{
                    ...
                    .ccda .table_simple td{
                        padding: 0;
                    }
                    .ccda .table_simple td.td_label{
                        font-size: <xsl:value-of select="$font-size-main"/>; /* IE8 hack: doesn't understand inheritance */
                        font-weight: inherit;
                        font-style: italic;
                        padding-right: 0.2cm;
                    ...
                    .ccda .revision_insert{
                        text-decoration: underline overline;
                    }
                    .ccda .revision_insert_final{
                    }
                    .ccda .revision_delete{
                        text-decoration: line-through;
                    }
                    .ccda .revision_delete_final{
                        display: none;
                    }
                    .ccda .span_button {
                        display: table-cell;
                ...
                <style type="text/css" media="screen">
                    .ccda div.button.expandCollapse {
                        float: left;
                        margin-right: 10px;
                        cursor: pointer;
                    }
